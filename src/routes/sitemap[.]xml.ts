...
const STATIC: SitemapEntry[] = [
  ...
  { path: "/8th-pay-commission-rajasthan", changefreq: "weekly", priority: "0.9" },
  ...
  { path: "/8th-pay-commission-uttar-pradesh", changefreq: "weekly", priority: "0.9" },
  { path: "/8th-pay-commission-maharashtra", changefreq: "weekly", priority: "0.9" },
