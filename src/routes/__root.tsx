...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Epilogue:wght@400;500;600;700&family=Urbanist:wght@600;700;800&display=swap",
      },
    ],
    scripts: [
      {
      ...
      },
      {
        ...
        children: JSON.stringify({
          ...
          potentialAction: {
            "@type": "SearchAction",
            target: "https://paycommissionnews.co.in/blog?q={search_term_string}",
